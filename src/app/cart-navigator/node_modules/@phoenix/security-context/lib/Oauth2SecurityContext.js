...
var checkTokenClient = "CHECK_TOKEN";
var checkTokenSecret = "Phnx@2729!";
...
var Oauth2SecurityContext = function (_SecurityContext) {
	_inherits(Oauth2SecurityContext, _SecurityContext);
  ...
  */
	function Oauth2SecurityContext(options) {
		_classCallCheck(this, Oauth2SecurityContext);

		var _this = _possibleConstructorReturn(this, (Oauth2SecurityContext.__proto__ || Object.getPrototypeOf(Oauth2SecurityContext)).call(this, options.defaultUsername));
		...
		_this._accessToken = "";
		_this.validataionFunctions = options.cookieValidation ? [_this.cookieValidation] : [];
	...
	_createClass(Oauth2SecurityContext, [{
		...
		value: function validateAndSetUsername(token) {
			...
			if (navigator.onLine) {
				...
				xhr.open('GET', this.validateUrl + "?token=" + token, false);
				xhr.setRequestHeader("Authorization", "Basic " + btoa(checkTokenClient + ":" + checkTokenSecret));
				...
				if (xhr.status == 200) {
					try {
						...
						this.username = data.user_name || data.sub || data.full_name;
						this.fullname = data.full_name;
						if (this.validataionFunctions.length == 0) {
		...
		value: function verifyToken() {
			...
			if (query != null && query.trim() != "" && query.includes("token")) {
				...
				if (token != null && token.trim() != "") {
					this.validateAndSetUsername(token);
		...
		value: function logout() {
			_get(Oauth2SecurityContext.prototype.__proto__ || Object.getPrototypeOf(Oauth2SecurityContext.prototype), "logout", this).call(this);
			this.accessToken = "";
		...
		get: function get() {
			this.validate();
			return _get(Oauth2SecurityContext.prototype.__proto__ || Object.getPrototypeOf(Oauth2SecurityContext.prototype), "isAuthenticated", this);
		},
		set: function set(bool) {
			_set(Oauth2SecurityContext.prototype.__proto__ || Object.getPrototypeOf(Oauth2SecurityContext.prototype), "isAuthenticated", bool, this);
		}
	}]);

	return Oauth2SecurityContext;
}(_SecurityContext3.default);

exports.default = Oauth2SecurityContext;