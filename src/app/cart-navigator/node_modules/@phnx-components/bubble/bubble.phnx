...
module.exports = {
    ...
    functions: {
        customRender: function() {
            ...
            d3.select(__elId__bubbleComp).selectAll("*").remove();


            let svg = d3.select(__elId__bubbleComp),
            ...
            try {
                ...
                g.selectAll(".dot")
                    ...
                    .enter().append("circle")
                    .attr("class", "dot")
                    .attr("r", function(d) { return z(Math.sqrt(d[__var__compMetadata.zAxisVariable])); })
                ...
                if (__var__showLegend) {
                    ...
                    legend.append("text")
                        ...
                        .text(__var__compMetadata.zAxisVariable);
                }
