...
module.exports = {
    ...
    variables: [{
    ...
    },
        {
            ...
            metadata: [{
                ...
                grouping: "General",
                target: "compStyle.__root.radius"
            }, {
                displayName: "Stroke",
                widget: "COLOR_PICKER",
                widgetData: {},
    ...
    localTemplates: {
      ...
      radialGradient: {
        ...
        id: "__fnParam__gradient.id",
        props: {
          cx: "__fnParam__gradient.cx",
          cy: "__fnParam__gradient.cy",
          r: "__fnParam__gradient.r",
          transform:"__fnParam__gradient.transform",
          scale:"__fnParam__gradient.scale"
        },
        children: ['__fnParam__gradient.stops.map(stop => __tmpl__stop)']
      },
      stop: {
    ...
    structure: {
        ...
        children: {
            ...
            props: {
                ...
                style: {
                    overflow: "initial",
                    verticalAlign:"top" // dummy comment
                }
            },
            children: [{
                type: "rect",
                props: {
                    width: "__var__compStyle.__root.width",
                    height: "__var__compStyle.__root.height",
                    rx: "__var__compStyle.__root.radius",
                    ry: "__var__compStyle.__root.radius",
                    style: {
