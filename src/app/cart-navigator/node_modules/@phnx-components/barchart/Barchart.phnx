 ...
 *   Description: This is a bar-chart with configurable options exposed and is an integral part of graphs in reusable components
 */
...
module.exports = {
    ...
    functions: {
        customRender: function() {
            ...
            d3.select(__elId__barComp).selectAll("*").remove();

            let padding = 20;

            let svg = d3.select(__elId__barComp),
